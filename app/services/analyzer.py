...
class TelegramAnalyzer:
    ...
    async def analyze(self, query_type: QueryType, raw_value: str, depth: int) -> AnalysisResult:
        ...
        if collected_payload.preview_only:
            return self._build_preview_result(normalized_input, depth, collected_payload)
        ...
        message_count = len(collected_payload.items)
        ...
        return AnalysisResult(
            ...
            summary="Публічних згадок або артефактів не виявлено" if not found else "",
    ...
    def _build_preview_result(
        ...
        return AnalysisResult(
            ...
            summary=payload.message or "Наразі джерела пошуку не підключені.",
        )
